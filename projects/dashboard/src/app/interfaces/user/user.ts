...
export interface Settings {
  ...
  oanda: {
    ...
    notifications: OandaNotificationSettings;
  };
  vultr: {
    notifications: VultrNotificationSettings;
  };
}

interface VultrNotificationSettings {
  onStart: boolean;
  onStop: boolean;
}
